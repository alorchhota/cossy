...
Filename: /cossy/cossyweb/config-files/icossy
This is a site config file. 
Probable location to copy this file to: /etc/apache2/sites-available/icossy
...
Filename: Rserv.conf
This is a Rserve config file.
Probable location to copy this file to: /etc/Rserv.conf
...
## You have to restart both apache and Rserve after setting these configurations.
